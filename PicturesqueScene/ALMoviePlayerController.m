...
//        [self performSelector:@selector(movieTimedOut) withObject:nil afterDelay:37.f];
    }
    
//    [self performSelector:@selector(play) withObject:nil afterDelay:36.f];
}
